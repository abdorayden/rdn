...
\lstdefinelanguage{Raden}{
  morekeywords={
    let,set,const,unlet,defun,apply,call,pcall,if,else,end,loop,break,
    continue,load,loadnative,add_load_path,add_native_path,true,false,null,
    print,type,to_string,exit,append,remove,index,len,enum,reset,error
  },
  sensitive=true,
  morecomment=[s]{[*}{*]},
  morestring=[b]"
...
Raden exposes a minimal embedding API through \code{include/src.h}.
